...
(function f_set_prototpe_for_F_AB() {
    ...
    //compare gottten xy with this.a and this.y
    ...
    //domino has contact by side with square on position p_nx_nx (including internal semi-domino's points)
    G.F_AB.prototype.f_contact_wh = function (p) { return (p.f_contact(this.a) || p.f_contact(this.b)); };
    //two dominos contact by side (they can intersect: have common cell)
    G.F_AB.prototype.f_contact_ab = function (ab) { return (this.f_contact_wh(ab.a) || this.f_contact_wh(ab.b)); };
}());